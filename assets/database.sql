...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 08, 2025 at 11:11 PM
...
ALTER TABLE `cart`
  ...
  ADD KEY `user_product_idx` (`user_id`,`product_id`),
  ADD KEY `cart_user_product` (`user_id`,`product_id`),
...
ALTER TABLE `orders`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_user_order` (`user_id`,`created_at`);
