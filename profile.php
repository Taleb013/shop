            ...
            if (!empty($_FILES['profile_image']['name'])) {
                ...
                if (in_array($file_extension, $allowed_extensions)) {
                    ...
                    if (move_uploaded_file($_FILES['profile_image']['tmp_name'], $target_path)) {
                        ...
                        // Delete old profile image if it exists under assets/uploads
                        if (!empty($user['profile_image'])) {
                            $old_image = __DIR__ . '/assets/uploads/' . $user['profile_image'];
...
// Initialize empty wishlist array for now
$wishlist = [];
// Wishlist feature will be implemented later
/* To implement wishlist, create this table in phpMyAdmin:
    ...
    <header class="profile-header">
        <div class="container text-center">
            <?php if (!empty($user['profile_image'])): ?>
                <img src="assets/uploads/<?= htmlspecialchars($user['profile_image']) ?>" class="rounded-circle mb-3" style="width: 120px; height: 120px; object-fit: cover;" alt="Profile Picture">
            <?php else: ?>
                                        ...
                                        <div class="col-md-6 mb-4">
                                            <div class="card h-100">
                                                <div class="card-body d-flex align-items-center">
                                                    <img src="assets/uploads/<?= htmlspecialchars($item['image']) ?>" class="me-3" style="width: 60px; height: 60px; object-fit: cover;" alt="<?= htmlspecialchars($item['name']) ?>">
                                                    <div>
